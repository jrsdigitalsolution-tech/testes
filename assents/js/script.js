...
function setFilter(status) {
  ...
  let modalUI; let modalResumoUI; let modalCompraUI; let modalPendenciaUI; let modalRecebimentoUI; let modalObraEl;
  ...
  function initModais() {
    ...
    const nestedModalIds = ['modalCompraItem', 'modalResumoGeral', 'modalPendenciaItem', 'modalRecebimentoItem'];
