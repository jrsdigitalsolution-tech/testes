  ...
  function renderizar(dadosOriginais) {
    ...
    if (isFiltroCarteiraAtual()) {
      ...
      if (dadosEntregueFiscal.length) {
        const chavesFiscais = getChavesFiscaisEntregue(dadosEntregueFiscal);
        const dadosEntregueOperacionalSemFiscal = expandirLinhasEntregueOperacionalSemFiscal(dadosOriginais, chavesFiscais);
        dadosPreparados = dadosEntregueFiscal.concat(dadosEntregueOperacionalSemFiscal);
      } else {
        const dadosEntregueOperacional = expandirLinhasEntreguePorPedido(dadosOriginais);
        dadosPreparados = dadosEntregueOperacional.length
          ? dadosEntregueOperacional
